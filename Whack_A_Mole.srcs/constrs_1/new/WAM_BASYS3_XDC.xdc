...
## Switches
set_property PACKAGE_PIN V17 [get_ports {Rst_}]					
...
set_property PACKAGE_PIN P1 [get_ports {Level[0]}]					
    set_property IOSTANDARD LVCMOS33 [get_ports {Level[0]}]
set_property PACKAGE_PIN L1 [get_ports {Level[1]}]					
...
##Buttons
#C
set_property PACKAGE_PIN U18 [get_ports Hits_Btn[1]]						
	set_property IOSTANDARD LVCMOS33 [get_ports Hits_Btn[1]]
#U
set_property PACKAGE_PIN T18 [get_ports Hits_Btn[3]]						
	set_property IOSTANDARD LVCMOS33 [get_ports Hits_Btn[3]]
#L
set_property PACKAGE_PIN W19 [get_ports Hits_Btn[0]]						
	set_property IOSTANDARD LVCMOS33 [get_ports Hits_Btn[0]]
#R
set_property PACKAGE_PIN T17 [get_ports Hits_Btn[2]]						
	set_property IOSTANDARD LVCMOS33 [get_ports Hits_Btn[2]]
#D
